...
export default function Footer() {
  ...
  const socials = [
    { icon: <GithubIcon size={18} />, href: "https://github.com/hirendomadiya", label: "GitHub" },
    { icon: <LinkedinIcon size={18} />, href: "https://linkedin.com/in/hirendomadiya", label: "LinkedIn" },
    { icon: <TwitterIcon size={18} />, href: "https://twitter.com/hirendomadiya", label: "Twitter" },
    { icon: <Mail size={18} />, href: "mailto:hirendomadiya@gmail.com", label: "Email" },
  ];
